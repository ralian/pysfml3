...
void bind_window(py::module_& m) {
    ...
    //mouse.def("set_position", py::overload_cast<const sf::Vector2i&>(&sf::Mouse::setPosition), "Set mouse position relative to desktop");
    //mouse.def("set_position", py::overload_cast<const sf::Vector2i&, const sf::WindowBase&>(&sf::Mouse::setPosition), "Set mouse position relative to window");
